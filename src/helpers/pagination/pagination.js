...
export function createPagination(pages, page) {
  ...
  if (page > 1) {
    str += '<li class="page-item previous no"><a>Previous</a></li>';
  }
  ...
  // Use "..." to collapse pages outside of a certain range
    ...
    for (let p = pageCutLow; p <= pageCutHigh; p++) {
      ...
      active = page == p ? "active" : "no";
      str += '<li class="page-item ' + active + '"><a>' + p + "</a></li>";
    }
    ...
    if (page < pages - 1) {
      ...
      str += '<li class="page-item no"><a>' + pages + "</a></li>";
    }
  }
  // Show the Next button only if you are on a page other than the last
  if (page < pages) {
    str += '<li class="page-item next no"><a>Next</a></li>';
  }
  str += "</ul>";
