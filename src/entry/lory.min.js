      ...
      function o(e, t) {
          ...
          (z = N),
            ...
            F.infinite
              ...
              : ((P = m.call(k.children)),
                ...
                T && 1 === P.length && !F.rewind && T.classList.add(b)),
            p(),
            g && n(P, z),
            B &&
              T &&
              (B.addEventListener("click", E), T.addEventListener("click", y)),
          ...
          (_ = l(k)),
            ...
            t
              ? (s(-1 * P[z + t].offsetLeft, 0, null),
                (z += t),
                (j.x = -1 * P[z].offsetLeft))
              : (s(-1 * P[z].offsetLeft, o, i), (j.x = -1 * P[z].offsetLeft)),
            a && n(m.call(P), z);
        }
        function b(e) {
          c(e);
        ...
        function g(e) {
          var t = e.touches ? e.touches[0] : e,
            ...
            i = t.pageY;
          (R = { x: n - X.x, y: i - X.y }),
            void 0 === Q && (Q = !!(Q || Math.abs(R.x) < Math.abs(R.y))),
            !Q && X && s(j.x + R.x, 0, null),
